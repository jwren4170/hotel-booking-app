...
export default function CreateListing() {
	...
	const handleImageSubmit = async () => {
		...
		try {
			...
			setFormData((prev) => ({
				...prev,
				imageUrls: prev.imageUrls.concat(data.urls ?? []),
			}));
			setFiles([]);
		} catch (err) {
			setImageUploadError(
	...
	return (
		<main className="mx-auto p-3 max-w-4xl">
			...
			<form onSubmit={handleSubmit} className="flex sm:flex-row flex-col gap-4">
				...
				<div className="flex flex-col flex-1 gap-4">
					...
					<div className="flex gap-4">
						...
						<button
							...
							className="disabled:opacity-80 hover:shadow-lg p-3 border border-green-700 rounded text-green-700 uppercase"
						>
						...
						formData.imageUrls.map((url, index) => (
							...
							>
								...
								<button
									...
									className="hover:opacity-75 p-3 rounded-lg text-red-700 uppercase"
								>
									Delete
								</button>
							</div>
